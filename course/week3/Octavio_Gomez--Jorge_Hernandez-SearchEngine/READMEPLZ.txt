...
About ExProj.cpp:
	...
	It uses a tree like structure to autocomplete a word using prefixes.
...
Flow description:
	...
	-This word will then enter a process in which it will be analyzed character by character.
	...
	-When the search is over, the program will return the complete word (if the user provided a prefix) and a text 		 containing information about the requested subject.
